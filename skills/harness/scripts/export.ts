...
if (format === "tgz") {
  ...
  r = spawnSync("tar", tarArgs, { encoding: "utf8", cwd: parent, windowsHide: true });
} else {
...
`;
  r = spawnSync("python3", ["-c", py, archiveSource, outputPath, includeAudit ? "true" : "false"], { encoding: "utf8", windowsHide: true });
}
